...
import project.pipepipe.app.ui.items.DisplayType
            ...
            Box(
                ...
                Text(
                    text = if (isSearchActive && uiState.searchQuery.isNotEmpty()) {
                        stringResource(MR.strings.playlist_empty_search_result)
                            .format(uiState.searchQuery)
                    } else {
                        stringResource(MR.strings.playlist_empty_no_streams)
                    },
                    fontSize = 16.sp,
